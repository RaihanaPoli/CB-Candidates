export PROJECT_HOME="/ds1/pdi/vtop/HRIT/cb_candidates/cb_candidates/PDI/Common"
...
export LOG_DIR="/ds1/pdi/data/CB/log/cb_candidates"
...
log_ext='.log'
log_file=${LOG_DIR}/$file_folder_name/'cb_candidates-'$log_date$log_ext
...
if  [ $ce -gt 0 ]; then
  ...
  } | mailx -s $host_name' - CB cb_candidates PDI Process - ' -r noreply@kuehne-nagel.com amer.hrit.support@kuehne-nagel.com
fi